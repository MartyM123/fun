const words = ["1. You create your own opportunities. Success doesn’t just come and find you–you have to go out and get it."
...
,"15. Allow others to figure things out for themselves. The fixer ends up becoming the enabler. Let people figure it out for themselves; give them a chance to lern."
,"16. Confidence is essential for a successful life. Don’t compare yourself to others; compare yourself to th person you were yesterday and give yourself the confidence to be better tomorrow."
,"17. Admit your mistakes and don’t repeat them. If you can’t admit your mistakes, you are destined to repeat them"
,"18. Be kind to yourself and forgive yourself. You can’t know what you haven’t yet learned, you can’t become profcient without first being a beginner and you can’t be perfect. Welcome to the human race."
,"19. Failures are lessons in progress. Failure is always forgivable if you have the courage to learn its lesons and move forward in a new way."
...
happy.addEventListener('click', function handleClick() {
  const initialText = 'Click me';
    happy.textContent = words[getRandomInt(0,34)];
});